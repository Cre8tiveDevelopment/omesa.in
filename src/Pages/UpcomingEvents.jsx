...
export default function UpcomingEvents() {
  const events = [
    ...
    },
    {
      ...
      venue: "The Minesota Expo Center",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {events.map((event) => (
            <div key={event.id} className="bg-white rounded shadow-none border-0">
              ...
              <div className="p-4">
                <h3 className="font-[HeadingText] text-fs-24 font-medium leading-tight">{event.title}</h3>
                <p className="text-fs-16 font-[TextFont] font-medium text-gray-900  leading-relaxed">{event.description}</p>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="text-sm space-y-1">
                      ...
                      <p className="text-gray-900 text-fs-16 font-[TextFont] font-medium">{event.venue}</p>
                      <p className="text-gray-900 text-fs-16 font-[TextFont] font-medium">{event.address}</p>
