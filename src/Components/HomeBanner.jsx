  ...
  return (
    ...
    >
      <main className=" sticky h-screen px-6 lg:px-12 py-4 bg-gradient-to-r from-[#03051E] via-[#0e1f4b] to-[#1D53B7] overflow-hidden">
        ...
        >
          <source src="/BannerVideo/BannerVideo.mp4" type="video/mp4" />
        ...
        <div className="max-w-5xl mt-28">
          <div className="space-y-8 text-left lg:text-left py-52 px-28">
            <div className="space-y-4 ">
              ...
              <p
                className={`text-white text-lg lg:text-xl max-w-2xl leading-relaxed mx-auto lg:mx-0 transform transition-all duration-700 ease-out delay-200 font-[textFont] ${
                  animateLines
                    ? "translate-y-0 opacity-100"
                    : "translate-y-10 opacity-0"
                }`}
