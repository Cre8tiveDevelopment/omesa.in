    ...
    <section className="bg-[#010616] text-white py-20 px-6 md:px-12 lg:px-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16 ">
          ...
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-normal  leading-tight bg-gradient-to-r from-gray-500 via-neutral-300 to-slate-200 bg-clip-text text-transparent py-4">
