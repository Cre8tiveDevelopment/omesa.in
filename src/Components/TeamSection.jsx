      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-8 mb-12">
          <div className="flex-1">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-5xl font-normal leading-tight bg-gradient-to-r from-gray-500 via-neutral-300 to-slate-200 bg-clip-text text-transparent">
              Our Creative Team
            </h2>
          </div>
        </div>
